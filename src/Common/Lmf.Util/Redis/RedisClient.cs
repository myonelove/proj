    ...
    public class RedisClient
    {
        ...
        public RedisClient(int dbNum, string readWriteHosts)
        {
            ...
            _conn =
                ...
                RedisConnectionClient.Instance :
                RedisConnectionClient.GetConnectionMultiplexer(readWriteHosts);
        }
        ...
        {
            var prefixKey = CustomKey ?? RedisConnectionClient.SysCustomKey;
